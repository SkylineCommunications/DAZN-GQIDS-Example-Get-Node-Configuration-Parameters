	...
	public static class SlcWorkflowIds
	{
		...
		public static class Sections
		{
			...
			public static class ProfileParameterValues
			{
				...
				public static FieldDescriptorID IsRequiredCapability
				{
					get;
				}

				= new FieldDescriptorID(new Guid("0d8512fc-349b-421a-9787-ea38c7f45ac3"));
				public static FieldDescriptorID IsRequiredCapacity
				{
					get;
				}

				= new FieldDescriptorID(new Guid("a4001af4-92c6-4800-993c-f0c6c11d339b"));
			}
			...
			public static class NodeCapacities
			{
				public static SectionDefinitionID Id
				{
					get;
				...
				= new SectionDefinitionID(new Guid("89c8f2fc-359e-49fb-88aa-1a7e2e638753"))
				{ ModuleId = "(slc)workflow" };
				...
				= new FieldDescriptorID(new Guid("eb9ff10c-a29b-4b5c-9b79-055703330b16"));
				public static FieldDescriptorID CapacityValue
				{
					get;
				}

				= new FieldDescriptorID(new Guid("2e5ccc4f-87bc-44a2-863f-6cd5c524032b"));
				public static FieldDescriptorID NodeId
				{
					get;
				}

				= new FieldDescriptorID(new Guid("3a9c4d8a-69be-4fe4-bf2d-292f4af6941f"));
			}
		...
		public static class Behaviors
		{
			public static class Workflow_Behavior
			{
				...
				public static class Statuses
				{
					...
					public const string Error = "7a2ab12e-d6c3-4efd-a044-78cabe3247ec";
				...
				public static class Transitions
				{
					...
					public const string Obsolete_To_Error = "obsolete_to_error";
				}
			...
			public static class Job_Behavior
			{
				...
				public static class Statuses
				{
					...
					public const string Error = "9a1d59b3-691a-4ad0-83ad-02770a033d27";
				...
				public static class Transitions
				{
					...
					public const string Draft_To_Error = "draft_to_error";
					public const string Completed_To_Error = "completed_to_error";
					public const string Error_To_Completed = "error_to_completed";
					...
					public const string Error_To_Canceled = "error_to_canceled";
					public const string Error_To_Running = "error_to_running";
					public const string Error_To_Confirmed = "error_to_confirmed";
					public const string Error_To_Tentative = "error_to_tentative";
					public const string Tentative_To_Error = "tentative_to_error";
					public const string Confirmed_To_Error = "confirmed_to_error";
					public const string Running_To_Error = "running_to_error";
...
namespace DomHelpers.SlcWorkflow
{
	...
	public partial class JobsInstance : DomInstanceBase
	{
		...
		/// <summary>
		/// Gets or sets the NodeCapacities section of the DOM Instance.
		/// </summary>
		public IList<NodeCapacitiesSection> NodeCapacities
		{
			get;
			private set;
		}
		...
		public override DomInstance ToInstance()
		{
			...
			domInstance.Sections.Add(MonitoringSettings.ToSection());
			foreach (var item in NodeCapacities)
			{
				domInstance.Sections.Add(item.ToSection());
			}
		...
		protected override void InitializeProperties()
		{
			...
			MonitoringSettings = new MonitoringSettingsSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcWorkflowIds.Sections.MonitoringSettings.Id)));
			NodeCapacities = domInstance.Sections.Where(section => section.SectionDefinitionID.Equals(SlcWorkflowIds.Sections.NodeCapacities.Id)).Select(section => new NodeCapacitiesSection(section)).ToList();
...
namespace DomHelpers.SlcWorkflow
{
	...
	public partial class ProfileParameterValuesSection : DomSectionBase
	{
		...
		/// <summary>
		/// Gets or sets the IsRequiredCapability field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		/// </list>
		/// </remarks>
		public Boolean? IsRequiredCapability
		{
			get
			{
				var wrapper = section.GetValue<Boolean>(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapability);
				if (wrapper != null)
				{
					return (Boolean?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapability);
				}
				else
				{
					section.AddOrUpdateValue(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapability, (Boolean)value);
				}
			}
		}

		/// <summary>
		/// Gets or sets the IsRequiredCapacity field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		/// </list>
		/// </remarks>
		public Boolean? IsRequiredCapacity
		{
			get
			{
				var wrapper = section.GetValue<Boolean>(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapacity);
				if (wrapper != null)
				{
					return (Boolean?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapacity);
				}
				else
				{
					section.AddOrUpdateValue(SlcWorkflowIds.Sections.ProfileParameterValues.IsRequiredCapacity, (Boolean)value);
				}
			}
		}
	...
	/// <summary>
	/// Represents a wrapper class for accessing a NodeCapacitiesSection section.
	/// The <see cref="NodeCapacitiesSection"/> class provides simplified access to the data and functionality of the underlying DOM section, allowing for easier manipulation and retrieval of data from DOM.
	/// </summary>
	public partial class NodeCapacitiesSection : DomSectionBase
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="NodeCapacitiesSection"/> class. Creates an empty <see cref="NodeCapacitiesSection"/> object with default settings.
		/// </summary>
		public NodeCapacitiesSection() : base(SlcWorkflowIds.Sections.NodeCapacities.Id)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="NodeCapacitiesSection"/> class using the specified <paramref name="section"/> for initializing the object.
		/// </summary>
		/// <param name="section">The <see cref="Section"/> object that provides data for initializing the <see cref="NodeCapacitiesSection"/>. If the section is <c>null</c>, the constructor will not perform any initialization.</param>
		public NodeCapacitiesSection(Section section) : base(SlcWorkflowIds.Sections.NodeCapacities.Id)
		{
			if (section == null)
			{
				return;
			...
			if (!section.SectionDefinitionID.Equals(SlcWorkflowIds.Sections.NodeCapacities.Id))
			{
				throw new ArgumentException($"The given section, is not of type '{nameof(SlcWorkflowIds.Sections.NodeCapacities.Id)}'", nameof(section));
			}
		...
		/// <summary>
		/// Gets or sets the Capacity field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		/// </list>
		/// </remarks>
		public Guid? Capacity
		{
			get
			{
				var wrapper = section.GetValue<Guid>(SlcWorkflowIds.Sections.NodeCapacities.Capacity);
				if (wrapper != null)
				{
					return (Guid?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcWorkflowIds.Sections.NodeCapacities.Capacity);
				}
				else
				{
					section.AddOrUpdateValue(SlcWorkflowIds.Sections.NodeCapacities.Capacity, (Guid)value);
				}
			}
		}

		/// <summary>
		/// Gets or sets the CapacityValue field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		public Double? CapacityValue
		{
			get
			{
				var wrapper = section.GetValue<Double>(SlcWorkflowIds.Sections.NodeCapacities.CapacityValue);
				if (wrapper != null)
				{
					return (Double?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcWorkflowIds.Sections.NodeCapacities.CapacityValue);
				}
				else
				{
					section.AddOrUpdateValue(SlcWorkflowIds.Sections.NodeCapacities.CapacityValue, (Double)value);
				}
			}
		}
		...
		public String NodeId
		{
			get
			{
				var wrapper = section.GetValue<String>(SlcWorkflowIds.Sections.NodeCapacities.NodeId);
				if (wrapper != null)
				{
					return (String)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcWorkflowIds.Sections.NodeCapacities.NodeId);
				}
				else
				{
					section.AddOrUpdateValue(SlcWorkflowIds.Sections.NodeCapacities.NodeId, (String)value);
				}
			}
		}
	}
